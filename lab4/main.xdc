...
set_property -dict { PACKAGE_PIN P1 IOSTANDARD LVCMOS33 } [get_ports dec_start];
set_property -dict { PACKAGE_PIN P5 IOSTANDARD LVCMOS33 } [get_ports hex_count];
set_property -dict { PACKAGE_PIN W4 IOSTANDARD LVCMOS33 } [get_ports en];
set_property -dict { PACKAGE_PIN C19 IOSTANDARD LVCMOS33 } [get_ports led_en[1]];
set_property -dict { PACKAGE_PIN E19 IOSTANDARD LVCMOS33 } [get_ports led_en[2]];
set_property -dict { PACKAGE_PIN D19 IOSTANDARD LVCMOS33 } [get_ports led_en[3]];
set_property -dict { PACKAGE_PIN F18 IOSTANDARD LVCMOS33 } [get_ports led_en[4]];
set_property -dict { PACKAGE_PIN E18 IOSTANDARD LVCMOS33 } [get_ports led_en[5]];
set_property -dict { PACKAGE_PIN B20 IOSTANDARD LVCMOS33 } [get_ports led_en[6]];
set_property -dict { PACKAGE_PIN A20 IOSTANDARD LVCMOS33 } [get_ports led_en[7]];
